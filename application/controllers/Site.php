    ...
    function add_encounters(){
    	...
    	if($this->session->userdata("user_firstform") != 1)
    	{
	        ...
	        if($this->session->userdata('filter_age_from')) 
	        {
		        ...
		        $users = $this->user_model->get_like_registered_users_page($config["per_page"], $page, $age_from, $age_to, $gender, $country, $city, $sort_by, $this->session->userdata('user_id'))->result_array();
