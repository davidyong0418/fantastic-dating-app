...
<div class="container">
	...
	<div class="row">
		<div class="pull-left">
			<h3><?php echo $this->lang->line("chatroom") ?></h3>
		</div>
	    <div class="pull-right">
		    <div class="btn_filter_placeholder">
		    	<a href="<?php echo base_url(); ?>chatroom/create" class="btn btn-primary btn-forum-new-topic">
				...
				<div class="forum-item active">
	                <div class="row">
	                    <div class="col-md-10">
							...
							<a class="forum-item-title" href="<?php echo base_url("chatroom/topic/" . $topic["tid"]) ?>"><?php echo $topic["title"] ?></a>
	                    ...
	                    <div class="col-md-2 forum-info">
	                        <span class="views-number"><?php echo $this->db->count_all_results('chatroom_chats');?></span>
							<div>
