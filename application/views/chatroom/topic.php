			    ...
			    <div class="chat-discussion chat-forum">
					...
					<div class="chat-message right">
						...
						<div class="topic-author">
							<?php echo sprintf($this->lang->line("by_topic"), $gender_user_color, base_url("user/profile/".$topic->uid), ucfirst($topic->username), base_url() . " forum/category/" ); ?>
						</div>
					...
					<div class="chat-message right">
			            ...
			            ?>
						<div class="pull-right topic-actions">
							<a href="<?php echo base_url(); ?>chatroom/editanswer/<?php echo $answer["id"]; ?>"><i class="fa fa-pencil"></i> <?php echo $this->lang->line("Edit") ?></a>
							|
							<a class="delete_answer" href="<?php echo base_url(); ?>chatroom/deleteanswer/<?php echo $answer["id"]; ?>"><i class="fa fa-times"></i> <?php echo $this->lang->line("Delete") ?></a>
						</div>
						<?php
						endif;
						?>
