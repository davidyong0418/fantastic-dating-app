			...
			<div class="panel-group panel-settings" id="accordion" role="tablist" aria-multiselectable="true">
				...
				<div class="panel panel-success">
					<div class="panel-heading" role="tab" id="resetpassword_tab">
						<h4 class="panel-title">
						<a class="resetpassword" data-toggle="collapse" data-parent="#accordion" href="#resetpassword" aria-expanded="false" aria-controls="collapseTwo">
					...
					<div id="resetpassword" class="panel-collapse collapse" role="tabpanel" aria-labelledby="resetpassword_tab">
						<div class="panel-body">
							<form action="<?php echo base_url() ?>resetpassword" method="POST" class="form-horizontal form-edit-infos col-md-8 col-md-offset-2">
								<div class="form-group">
