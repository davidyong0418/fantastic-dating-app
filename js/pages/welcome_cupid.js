...
$(".forgotpassmodal").html("<div class='alert alert-success' style='text-align:center; font-size:18px;'><i class='fa fa-check-circle' style='font-size:40px;'></i><br />" + recover_password_success_str + "</div>");
					}
			}
		});
	});
